(module
  ...
  (func $duff_count (export "duff_count") (param $p0 i32) (result i32)
    (local $pc i32)
    (local $fp i32)
    (local $carry i32)
    (local $r0 i32)
    ...
    (loop $dispatch
      (if (i32.eq (local.get $pc) (i32.const 0))
        (then
          ...
          (local.set $r0 (i32.div_s (i32.add (i32.load (i32.add (local.get $fp) (i32.const -4))) (i32.const 7)) (i32.const 8)))
          ...
          (local.set $r0 (i32.rem_s (i32.load (i32.add (local.get $fp) (i32.const -4))) (i32.const 8)))
      ...
      (if (i32.eq (local.get $pc) (i32.const 2))
        (then
          (local.set $r0 (i32.add (i32.load (i32.add (local.get $fp) (i32.const -12))) (i32.const 7)))
          (i32.store (i32.add (local.get $fp) (i32.const -12)) (local.get $r0))
      ...
      (if (i32.eq (local.get $pc) (i32.const 3))
        (then
          (local.set $r0 (i32.add (i32.load (i32.add (local.get $fp) (i32.const -12))) (i32.const 6)))
          (i32.store (i32.add (local.get $fp) (i32.const -12)) (local.get $r0))
      ...
      (if (i32.eq (local.get $pc) (i32.const 4))
        (then
          (local.set $r0 (i32.add (i32.load (i32.add (local.get $fp) (i32.const -12))) (i32.const 5)))
          (i32.store (i32.add (local.get $fp) (i32.const -12)) (local.get $r0))
      ...
      (if (i32.eq (local.get $pc) (i32.const 6))
        (then
          (local.set $r0 (i32.add (i32.load (i32.add (local.get $fp) (i32.const -12))) (i32.const 3)))
          (i32.store (i32.add (local.get $fp) (i32.const -12)) (local.get $r0))
      ...
      (if (i32.eq (local.get $pc) (i32.const 7))
        (then
          (local.set $r0 (i32.add (i32.load (i32.add (local.get $fp) (i32.const -12))) (i32.const 2)))
          (i32.store (i32.add (local.get $fp) (i32.const -12)) (local.get $r0))
